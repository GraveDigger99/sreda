(() => {
    ...
    (() => {
        ...
        let programsSliderSwiper;
        function programsSliderMobile() {
            if (window.innerWidth <= 767.98 && "false" == programsSlider.dataset.mobile) {
                programsSliderSwiper = new core(".programs__slider", {
                ...
                programsSlider.dataset.mobile = "true";
            }
            if (window.innerWidth > 767.98) {
                programsSlider.dataset.mobile = "false";
                if (programsSlider.classList.contains("swiper-initialized")) programsSliderSwiper.destroy();
            }
        }
        function mobileSlider() {
            if (window.innerWidth <= 767.98 && "false" == advantagesSlider.dataset.mobile) {
                mySwiper = new core(".advantages__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1.2,
            ...
            if (window.innerWidth > 767.98) {
                ...
                if (advantagesSlider.classList.contains("swiper-initialized")) mySwiper.destroy();
            }
        }
